...
class CancelingOrdersScreen extends StatefulWidget {
  ...
  @override
  State<CancelingOrdersScreen> createState() => CancelringOrdersScreenState();
}

class CancelringOrdersScreenState extends State<CancelingOrdersScreen> {
            ...
            child: SingleChildScrollView(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where('orderStatus', isEqualTo: 'تعذر الرفع')
                    .snapshots(),
                builder: (
