...
class CertificatesReviewedScreen extends StatefulWidget {
  ...
  const CertificatesReviewedScreen(
      {super.key,
  ...
  @override
  State<CertificatesReviewedScreen> createState() =>
      CancelringOrdersScreenState();
}

class CancelringOrdersScreenState extends State<CertificatesReviewedScreen> {
            ...
            child: SingleChildScrollView(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where('orderStatus', isEqualTo: 'شهادات تمت مراجعتها')
                    .snapshots(),
                builder: (
